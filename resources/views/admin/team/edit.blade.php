...
<script>
    ...
    // Menambahkan event listener pada formulir untuk mengaktifkan/menonaktifkan tombol simpan info
    pegawaiForm.addEventListener('input', function () {
        // Jika input nama atau email berubah, aktifkan tombol simpan info
        submitInfoButton.removeAttribute('disabled');
    });
</script>
@endsection